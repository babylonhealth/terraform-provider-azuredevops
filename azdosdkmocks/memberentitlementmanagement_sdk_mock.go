...
func (m *MockMemberentitlementmanagementClient) GetUserEntitlements(arg0 context.Context, arg1 memberentitlementmanagement.GetUserEntitlementArgs) (*memberentitlementmanagement.PagedGraphMemberList, error) {
	m.ctrl.T.Helper()
